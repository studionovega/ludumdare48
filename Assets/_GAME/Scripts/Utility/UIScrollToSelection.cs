...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UIScrollToSelection : MonoBehaviour
    {
        ...
        private void UpdateVerticalScrollPosition(RectTransform selection)
        {
            ...
            if (TargetScrollRect.verticalNormalizedPosition + (offlimitsValue / LayoutListGroup.rect.height) * Time.unscaledDeltaTime * scrollSpeed < TargetScrollRect.verticalNormalizedPosition)
            {
                TargetScrollRect.verticalNormalizedPosition += (offlimitsValue / LayoutListGroup.rect.height) * Time.unscaledDeltaTime * scrollSpeed;
            }
            else
            {
